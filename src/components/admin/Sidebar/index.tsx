...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  useClickOutside([trigger, sidebar], () => setSidebarOpen(false));
  ...
  return (
    <aside
      ref={sidebar}
      className={`z-102 absolute left-0 top-0 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear lg:static lg:translate-x-0 ${
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              ...
              <li>
                <Link
                  href='/admin/projects'
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark ${
                    !!pathname?.includes('projects') && 'bg-graydark'
                  }`}
                >
                  <svg
                    className='fill-current'
